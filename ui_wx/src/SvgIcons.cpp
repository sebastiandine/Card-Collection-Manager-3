...
// Warning triangle + bang (paths only — NanoSVG does not render <text>).
const char* const kSvgAlert = R"SVG(<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
  <path fill="none" stroke="@FILL@" stroke-width="1.5" stroke-linejoin="round"
        d="M8 2.4 L14.3 13.5 H1.7 Z"/>
  <rect x="7.25" y="6.0" width="1.5" height="4.3" rx="0.4" fill="@FILL@"/>
  <rect x="7.25" y="11.2" width="1.5" height="1.5" rx="0.4" fill="@FILL@"/>
</svg>)SVG";

// Checkmark as a simple filled path (NanoSVG does not need stroke-linejoin).
const char* const kSvgCheck = R"SVG(<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
  <path fill="@FILL@" d="M6.2 12.7 L1.7 8.2 L3.2 6.7 L6.2 9.7 L12.8 3.1 L14.3 4.6 Z"/>
</svg>)SVG";
